...
export const placeOrder = async (orderTotal, dispatch) => {
    console.log('order placed super', orderTotal);

    try {
        await axios.post("http://localhost:5065/api/orders", { OrderTotal: orderTotal });
